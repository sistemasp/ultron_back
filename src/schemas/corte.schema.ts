...
export const CorteSchema = new Schema({
    ...
    turno: { type: String },
    entradas: [{ type: constMongoose.ObjectId, ref: 'Entrada' }],
    pagos_anticipados: [{ type: constMongoose.ObjectId, ref: 'Entrada' }],
    salidas: [{ type: constMongoose.ObjectId, ref: 'Salida' }],
