...
export class EsteticaService {
    ...
    async findEsteticaByConsultaId(consultaId): Promise<EsteticaI> {
        return await this.esteticaModel.findOne({ consultaId: consultaId })
            .populate('status')
            .populate('servicio');
    }
    ...
    /**
     * Muestra todas las esteticas de la BD que correspondan a un pagos de un dermatologo de algun dia 
     */
